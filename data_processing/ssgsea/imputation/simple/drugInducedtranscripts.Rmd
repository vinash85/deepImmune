...
---
```{r}
dataset.col.curr = fread("/homes6/asahu/liulab_home/projects/icb/data/tcga/scrna.v4.genes/skcm/dataset.txt", nrow=1)
if.start.inx = which(colnames(dataset.col.curr)== "B_cells_naive")
genes.analyzed = colnames(dataset.col.curr)[seq(2,if.start.inx)] %>% gsub("\\.", ., replacement="")
```
...
write.table(file = "/homes6/asahu/liulab_home/projects/icb/data/tcga/scrna.v4.genes/skcm/combined.drug.log2fc.txt", x = all.mat, quote = F, sep = "\t", row.names = F, col.names = T)
